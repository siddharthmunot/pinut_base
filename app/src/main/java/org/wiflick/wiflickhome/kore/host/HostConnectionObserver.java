 ...
 */
package org.wiflick.wiflickhome.kore.host;
...
import org.wiflick.wiflickhome.kore.jsonrpc.notification.Input;
import org.wiflick.wiflickhome.kore.jsonrpc.notification.System;
...
public class HostConnectionObserver
    ...
    public interface PlayerEventsObserver {
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently playing item, obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetItem}
         */
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently paused item, obtained by a call to {@link org.wiflick.wiflickhome.kore.jsonrpc.method.Player.GetItem}
         */
...
//        observerHandlerMap.remove(observer);
     ...
     */
    public void onPlay(org.wiflick.wiflickhome.kore.jsonrpc.notification.Player.OnPlay notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onPause(org.wiflick.wiflickhome.kore.jsonrpc.notification.Player.OnPause
                                notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSpeedChanged(org.wiflick.wiflickhome.kore.jsonrpc.notification.Player
                                       .OnSpeedChanged notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSeek(org.wiflick.wiflickhome.kore.jsonrpc.notification.Player.OnSeek notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onStop(org.wiflick.wiflickhome.kore.jsonrpc.notification.Player.OnStop notification) {
        // Just start our chain calls
