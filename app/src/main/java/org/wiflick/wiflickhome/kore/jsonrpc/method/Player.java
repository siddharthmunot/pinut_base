 ...
 */
package org.wiflick.wiflickhome.kore.jsonrpc.method;
...
import org.wiflick.wiflickhome.kore.jsonrpc.type.PlayerType.GetActivePlayersReturnType;
import org.wiflick.wiflickhome.kore.jsonrpc.type.PlaylistType;
import org.wiflick.wiflickhome.kore.utils.JsonUtils;
...
public class Player {
    ...
    public static final class SetSpeed extends ApiMethod<Integer> {
         ...
         * Set the speed of the current playback
         * @param playerId Player id for which to toggle the state
         * @param speed String enum in {@link org.wiflick.wiflickhome.kore.jsonrpc.type.GlobalType.IncrementDecrement}
         */
    ...
    public static final class SetRepeat extends ApiMethod<String> {
         ...
         * Set the repeat mode of the player
         * @param playerId Player id for which to stop playback
         * @param repeat Repeat mode, see {@link org.wiflick.wiflickhome.kore.jsonrpc.type.PlayerType.Repeat}
         */
