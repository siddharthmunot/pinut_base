...
import org.wiflick.wiflickhome.kore.jsonrpc.type.PVRType;
...
public class PVR {
    ...
    public static class GetChannelGroups extends ApiMethod<List<PVRType.DetailsChannelGroup>> {
         ...
         * Retrieves the channel groups for the specified type
         *
         * @param channeltype Channel type. See {@link org.wiflick.wiflickhome.kore.jsonrpc.type.PVRType.ChannelType}
         */
